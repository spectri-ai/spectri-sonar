...
# Template file
TEMPLATE_FILE="$REPO_ROOT/.spectri/templates/spectri-spectri/agent-file-template.md"
...
create_new_agent_file() {
    ...
    for substitution in "${substitutions[@]}"; do
        if ! sed_inplace -e "$substitution" "$temp_file"; then
